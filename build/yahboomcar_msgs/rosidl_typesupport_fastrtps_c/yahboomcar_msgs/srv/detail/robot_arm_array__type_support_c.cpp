...
#include "yahboomcar_msgs/srv/detail/robot_arm_array__rosidl_typesupport_fastrtps_c.h"
...
using _RobotArmArray_Request__ros_msg_type = yahboomcar_msgs__srv__RobotArmArray_Request;
...
size_t get_serialized_size_yahboomcar_msgs__srv__RobotArmArray_Request(
  const void * untyped_ros_message,
...
static uint32_t _RobotArmArray_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yahboomcar_msgs__srv__RobotArmArray_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yahboomcar_msgs
size_t max_serialized_size_yahboomcar_msgs__srv__RobotArmArray_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yahboomcar_msgs__srv__RobotArmArray_Request;
    is_plain =
      (
...
static size_t _RobotArmArray_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_yahboomcar_msgs__srv__RobotArmArray_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yahboomcar_msgs, srv, RobotArmArray_Request)() {
...
using _RobotArmArray_Response__ros_msg_type = yahboomcar_msgs__srv__RobotArmArray_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yahboomcar_msgs
size_t get_serialized_size_yahboomcar_msgs__srv__RobotArmArray_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RobotArmArray_Response__ros_msg_type * ros_message = static_cast<const _RobotArmArray_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_yahboomcar_msgs__srv__RobotArmArray_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yahboomcar_msgs
size_t max_serialized_size_yahboomcar_msgs__srv__RobotArmArray_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _RobotArmArray_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_yahboomcar_msgs__srv__RobotArmArray_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yahboomcar_msgs, srv, RobotArmArray_Response)() {
...
// already included above
// #include "yahboomcar_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "yahboomcar_msgs/srv/robot_arm_array.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yahboomcar_msgs, srv, RobotArmArray)() {
