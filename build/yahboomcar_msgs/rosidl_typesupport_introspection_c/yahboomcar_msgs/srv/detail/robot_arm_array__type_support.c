...
size_t yahboomcar_msgs__srv__RobotArmArray_Response__rosidl_typesupport_introspection_c__size_function__RobotArmArray_Response__angles(
...
const void * yahboomcar_msgs__srv__RobotArmArray_Response__rosidl_typesupport_introspection_c__get_const_function__RobotArmArray_Response__angles(
...
void * yahboomcar_msgs__srv__RobotArmArray_Response__rosidl_typesupport_introspection_c__get_function__RobotArmArray_Response__angles(
...
void yahboomcar_msgs__srv__RobotArmArray_Response__rosidl_typesupport_introspection_c__fetch_function__RobotArmArray_Response__angles(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const double * item =
    ((const double *)
    yahboomcar_msgs__srv__RobotArmArray_Response__rosidl_typesupport_introspection_c__get_const_function__RobotArmArray_Response__angles(untyped_member, index));
  double * value =
    (double *)(untyped_value);
  *value = *item;
}

void yahboomcar_msgs__srv__RobotArmArray_Response__rosidl_typesupport_introspection_c__assign_function__RobotArmArray_Response__angles(
  void * untyped_member, size_t index, const void * untyped_value)
{
  double * item =
    ((double *)
    yahboomcar_msgs__srv__RobotArmArray_Response__rosidl_typesupport_introspection_c__get_function__RobotArmArray_Response__angles(untyped_member, index));
  const double * value =
    (const double *)(untyped_value);
  *item = *value;
}

bool yahboomcar_msgs__srv__RobotArmArray_Response__rosidl_typesupport_introspection_c__resize_function__RobotArmArray_Response__angles(
...
static rosidl_typesupport_introspection_c__MessageMember yahboomcar_msgs__srv__RobotArmArray_Response__rosidl_typesupport_introspection_c__RobotArmArray_Response_message_member_array[1] = {
  {
    "angles",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yahboomcar_msgs__srv__RobotArmArray_Response, angles),  // bytes offset in struct
    NULL,  // default value
    yahboomcar_msgs__srv__RobotArmArray_Response__rosidl_typesupport_introspection_c__size_function__RobotArmArray_Response__angles,  // size() function pointer
    yahboomcar_msgs__srv__RobotArmArray_Response__rosidl_typesupport_introspection_c__get_const_function__RobotArmArray_Response__angles,  // get_const(index) function pointer
    yahboomcar_msgs__srv__RobotArmArray_Response__rosidl_typesupport_introspection_c__get_function__RobotArmArray_Response__angles,  // get(index) function pointer
    yahboomcar_msgs__srv__RobotArmArray_Response__rosidl_typesupport_introspection_c__fetch_function__RobotArmArray_Response__angles,  // fetch(index, &value) function pointer
    yahboomcar_msgs__srv__RobotArmArray_Response__rosidl_typesupport_introspection_c__assign_function__RobotArmArray_Response__angles,  // assign(index, value) function pointer
    yahboomcar_msgs__srv__RobotArmArray_Response__rosidl_typesupport_introspection_c__resize_function__RobotArmArray_Response__angles  // resize(index) function pointer
  }
};
