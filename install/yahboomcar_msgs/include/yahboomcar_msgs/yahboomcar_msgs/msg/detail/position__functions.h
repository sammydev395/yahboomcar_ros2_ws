...
#ifndef YAHBOOMCAR_MSGS__MSG__DETAIL__POSITION__FUNCTIONS_H_
#define YAHBOOMCAR_MSGS__MSG__DETAIL__POSITION__FUNCTIONS_H_
 ...
 * calls
 * yahboomcar_msgs__msg__Position__init().
...
/**
 * It calls
 * yahboomcar_msgs__msg__Position__fini()
 ...
 * yahboomcar_msgs__msg__Position__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * yahboomcar_msgs__msg__Position__Sequence__fini()
 * on the array,
...
#endif  // YAHBOOMCAR_MSGS__MSG__DETAIL__POSITION__FUNCTIONS_H_
