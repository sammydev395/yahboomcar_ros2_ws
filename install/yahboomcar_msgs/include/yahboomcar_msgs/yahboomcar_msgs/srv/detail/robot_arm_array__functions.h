...
#ifndef YAHBOOMCAR_MSGS__SRV__DETAIL__ROBOT_ARM_ARRAY__FUNCTIONS_H_
#define YAHBOOMCAR_MSGS__SRV__DETAIL__ROBOT_ARM_ARRAY__FUNCTIONS_H_
 ...
 * calls
 * yahboomcar_msgs__srv__RobotArmArray_Request__init().
...
/**
 * It calls
 * yahboomcar_msgs__srv__RobotArmArray_Request__fini()
 ...
 * yahboomcar_msgs__srv__RobotArmArray_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * yahboomcar_msgs__srv__RobotArmArray_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * yahboomcar_msgs__srv__RobotArmArray_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_yahboomcar_msgs
...
/**
 * It calls
 * yahboomcar_msgs__srv__RobotArmArray_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_yahboomcar_msgs
...
/**
 * It allocates the memory for the array and calls
 * yahboomcar_msgs__srv__RobotArmArray_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_yahboomcar_msgs
...
/**
 * It calls
 * yahboomcar_msgs__srv__RobotArmArray_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // YAHBOOMCAR_MSGS__SRV__DETAIL__ROBOT_ARM_ARRAY__FUNCTIONS_H_
