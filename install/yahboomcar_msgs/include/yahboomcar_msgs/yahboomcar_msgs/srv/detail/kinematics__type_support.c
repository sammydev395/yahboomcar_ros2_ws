...
static rosidl_typesupport_introspection_c__MessageMember yahboomcar_msgs__srv__Kinematics_Response__rosidl_typesupport_introspection_c__Kinematics_Response_message_member_array[2] = {
  {
    "target_joints",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_DOUBLE,  // type
    0,  // upper bound of string
