...
size_t size_function__Kinematics_Response__joint_1(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<float> *>(untyped_member);
  return member->size();
}

const void * get_const_function__Kinematics_Response__joint_1(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__Kinematics_Response__joint_1(void * untyped_member, size_t index)
{
  auto & member =
...
void fetch_function__Kinematics_Response__joint_1(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__Kinematics_Response__joint_1(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__Kinematics_Response__joint_1(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__Kinematics_Response__joint_1(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}

void resize_function__Kinematics_Response__joint_1(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<float> *>(untyped_member);
  member->resize(size);
...
size_t size_function__Kinematics_Response__joint_2(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<float> *>(untyped_member);
  return member->size();
}

const void * get_const_function__Kinematics_Response__joint_2(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<float> *>(untyped_member);
  return &member[index];
...
void * get_function__Kinematics_Response__joint_2(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<float> *>(untyped_member);
  return &member[index];
...
void fetch_function__Kinematics_Response__joint_2(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__Kinematics_Response__joint_2(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__Kinematics_Response__joint_2(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__Kinematics_Response__joint_2(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}

void resize_function__Kinematics_Response__joint_2(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<float> *>(untyped_member);
  member->resize(size);
...
size_t size_function__Kinematics_Response__joint_3(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<float> *>(untyped_member);
  return member->size();
}

const void * get_const_function__Kinematics_Response__joint_3(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<float> *>(untyped_member);
  return &member[index];
...
void * get_function__Kinematics_Response__joint_3(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<float> *>(untyped_member);
  return &member[index];
...
void fetch_function__Kinematics_Response__joint_3(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__Kinematics_Response__joint_3(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__Kinematics_Response__joint_3(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__Kinematics_Response__joint_3(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}

void resize_function__Kinematics_Response__joint_3(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<float> *>(untyped_member);
  member->resize(size);
...
size_t size_function__Kinematics_Response__joint_4(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<float> *>(untyped_member);
  return member->size();
}

const void * get_const_function__Kinematics_Response__joint_4(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<float> *>(untyped_member);
  return &member[index];
...
void * get_function__Kinematics_Response__joint_4(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<float> *>(untyped_member);
  return &member[index];
...
void fetch_function__Kinematics_Response__joint_4(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__Kinematics_Response__joint_4(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__Kinematics_Response__joint_4(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__Kinematics_Response__joint_4(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}

void resize_function__Kinematics_Response__joint_4(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<float> *>(untyped_member);
  member->resize(size);
...
size_t size_function__Kinematics_Response__joint_5(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<float> *>(untyped_member);
  return member->size();
}

const void * get_const_function__Kinematics_Response__joint_5(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<float> *>(untyped_member);
  return &member[index];
...
void * get_function__Kinematics_Response__joint_5(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<float> *>(untyped_member);
  return &member[index];
...
void fetch_function__Kinematics_Response__joint_5(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__Kinematics_Response__joint_5(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__Kinematics_Response__joint_5(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__Kinematics_Response__joint_5(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}

void resize_function__Kinematics_Response__joint_5(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<float> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Kinematics_Response_message_member_array[13] = {
  {
    "target_joints",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_DOUBLE,  // type
    0,  // upper bound of string
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yahboomcar_msgs::srv::Kinematics_Response, x),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yahboomcar_msgs::srv::Kinematics_Response, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yahboomcar_msgs::srv::Kinematics_Response, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yahboomcar_msgs::srv::Kinematics_Response, roll),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yahboomcar_msgs::srv::Kinematics_Response, pitch),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yahboomcar_msgs::srv::Kinematics_Response, yaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yahboomcar_msgs::srv::Kinematics_Response, joint_1),  // bytes offset in struct
    nullptr,  // default value
    size_function__Kinematics_Response__joint_1,  // size() function pointer
    get_const_function__Kinematics_Response__joint_1,  // get_const(index) function pointer
    get_function__Kinematics_Response__joint_1,  // get(index) function pointer
    fetch_function__Kinematics_Response__joint_1,  // fetch(index, &value) function pointer
    assign_function__Kinematics_Response__joint_1,  // assign(index, value) function pointer
    resize_function__Kinematics_Response__joint_1  // resize(index) function pointer
  },
  {
    "joint_2",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_FLOAT,  // type
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yahboomcar_msgs::srv::Kinematics_Response, joint_2),  // bytes offset in struct
    nullptr,  // default value
    size_function__Kinematics_Response__joint_2,  // size() function pointer
    get_const_function__Kinematics_Response__joint_2,  // get_const(index) function pointer
    get_function__Kinematics_Response__joint_2,  // get(index) function pointer
    fetch_function__Kinematics_Response__joint_2,  // fetch(index, &value) function pointer
    assign_function__Kinematics_Response__joint_2,  // assign(index, value) function pointer
    resize_function__Kinematics_Response__joint_2  // resize(index) function pointer
  },
  {
    "joint_3",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_FLOAT,  // type
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yahboomcar_msgs::srv::Kinematics_Response, joint_3),  // bytes offset in struct
    nullptr,  // default value
    size_function__Kinematics_Response__joint_3,  // size() function pointer
    get_const_function__Kinematics_Response__joint_3,  // get_const(index) function pointer
    get_function__Kinematics_Response__joint_3,  // get(index) function pointer
    fetch_function__Kinematics_Response__joint_3,  // fetch(index, &value) function pointer
    assign_function__Kinematics_Response__joint_3,  // assign(index, value) function pointer
    resize_function__Kinematics_Response__joint_3  // resize(index) function pointer
  },
  {
    "joint_4",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_FLOAT,  // type
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yahboomcar_msgs::srv::Kinematics_Response, joint_4),  // bytes offset in struct
    nullptr,  // default value
    size_function__Kinematics_Response__joint_4,  // size() function pointer
    get_const_function__Kinematics_Response__joint_4,  // get_const(index) function pointer
    get_function__Kinematics_Response__joint_4,  // get(index) function pointer
    fetch_function__Kinematics_Response__joint_4,  // fetch(index, &value) function pointer
    assign_function__Kinematics_Response__joint_4,  // assign(index, value) function pointer
    resize_function__Kinematics_Response__joint_4  // resize(index) function pointer
  },
  {
    "joint_5",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_FLOAT,  // type
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yahboomcar_msgs::srv::Kinematics_Response, joint_5),  // bytes offset in struct
    nullptr,  // default value
    size_function__Kinematics_Response__joint_5,  // size() function pointer
    get_const_function__Kinematics_Response__joint_5,  // get_const(index) function pointer
    get_function__Kinematics_Response__joint_5,  // get(index) function pointer
    fetch_function__Kinematics_Response__joint_5,  // fetch(index, &value) function pointer
    assign_function__Kinematics_Response__joint_5,  // assign(index, value) function pointer
    resize_function__Kinematics_Response__joint_5  // resize(index) function pointer
  }
};
