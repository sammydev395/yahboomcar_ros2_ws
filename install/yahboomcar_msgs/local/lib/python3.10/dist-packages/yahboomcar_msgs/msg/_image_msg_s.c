...
bool yahboomcar_msgs__msg__image_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
...
PyObject * yahboomcar_msgs__msg__image_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("yahboomcar_msgs.msg._image_msg");
